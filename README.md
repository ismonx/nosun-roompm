# 🏡 FU·PMS V6.0 — 旅宿營運矩陣 (Bilingual Matrix)

這是一套進化至 V6.0 的旅宿管理系統 (Property Management System)，專為追求效率與美感的「現代經營者」打造。從單一訂房頁進化為具備多租戶潛力的營運中樞，全面自動化處理定價、房控與旅客轉化。
...
### 1. 專業營運矩陣 (Matrix OS)
*   **週檢視 (Week View)**：自動伸展佈局。房型欄固定，日期欄根據螢幕自動延伸。提供上週/下週/今日快速切換。
*   **月檢視 (Month View)**：整合式全月統計，支援年月快速跳轉，點擊日期可直達該週細節。
*   **介面進化**：全站採用 `rounded-md` (6px) 圓角收斂，搭配頂部水平工具列，最大化工作可視空間。
*   **推薦夥伴/優惠碼系統**：空房轉換推薦夥伴/分館，滿房推薦其他單位以利提高轉換率 `promo_codes` 模組，支援折扣率自訂、到期日限制與即時驗證。
